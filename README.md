...
\[cole o seu texto\] Reveja a minha escrita acima. Corrija erros de
...
Quero aprender sobre \[insira o tema\]. Identifique e compartilhe os 20%
...
Quero aprender/melhorar em \[insira a habilidade desejada\]. Sou um
...
Resuma o livro \[insira o nome do livro\] do autor \[insira o nome do
...
Assuma que você é \[insira o nome de uma pessoa famosa, como Steve
Jobs\]. Leia meu argumento abaixo e me dê feedback como se você fosse
\[insira a pessoa novamente\] \[insira seu argumento\]
...
Seu papel é o de solucionador de problemas. Dê-me um guia passo a passo
para resolver \[insira seu problema\]. Inclua explicações claras para
cada um dos passos.
...
Estou escrevendo um post de blog sobre \[insira o tema\]. Forneça-me um
esboço para este post de blog com 10 tópicos em forma de tópicos. Além
disso, dê-me 5 opções de título cativante. (Você pode adaptar este
prompt para o que estiver escrevendo.)
...
I am writing a \[insert thing e.g. a blog about affordable cars\]. Give
me a list of 10 ideas for \[insert thing\].

Prompt:

I'm writing a blog post about \[insert topic\]. I can't come up with a
catchy title. Give me a list of 5 suggestions for the blog title for
this piece.
...
Atualmente estou aprendendo sobre \[insira o tema\]. Converta as
...
Atualmente estou aprendendo sobre \[insira o tema\]. Faça-me uma série
de perguntas que testem meu conhecimento. Identifique lacunas de
...
I am interviewing for \[enter position\]. Can you give me a
...
Rewrite the text below in simple and easy to understand words. Simple
...
Estou tentando decidir se devo \[inserir decisão\]. Dê-me uma lista de
...
Estou criando um relatório sobre \[inserir tópico\]. Pesquise e crie um
...
You are an AI designed to help \[insert profession\]. Generate a list of
...
Use First Principles Thinking to evaluate \[insert your decision\]. Give
...
\[Insert problem\] Instead of working from the start, start from the
...
\[Insert decision\] Generate a list of possible regrets this decision
...
Assume that \[insert assumption\] is incorrect. Plan a roadmap with a
...
- Fazer perguntas sobre o que o ChatGPT precisa para que ele me dê
  ...
  pegar mais contexto quando dou as informações que ele precisa
- Quanto mais específica a pergunta, mais precisa é a resposta
- Assim como estudava a matéria antes de ir para aula, para casos
  similares pode-se pedir para o ChatGPT montar 5 perguntas de
  princípios básicos sobre determinado assunto que se queira aprender.
...
- Develop an architecture and code for a \[website description\] website
  with JavaScript.
- Continue writing the following JavaScript code: \[insert code\].
- Find the bug within code: \[post code\].
...
- Generate a creative social media content calendar for the next month
  for our \[product\].
- Create a 2-minute video script for a Facebook ad campaign promoting
  \[product or service\].
